...
Now that we have WinSock DLL loaded, next step is to get WSAStartup address so we can call it. From [MSDN](https://docs.microsoft.com/en-us/windows/desktop/api/winsock/nf-winsock-wsastartup):

> The WSAStartup function initiates use of the Winsock DLL by a process.

We use GetProcAddress for it. Here it is its syntax:
